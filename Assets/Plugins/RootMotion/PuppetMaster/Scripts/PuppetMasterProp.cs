...
namespace RootMotion.Dynamics {
	...
	public class PuppetMasterProp : MonoBehaviour {
		...
		public Rigidbody GetRigidbody() {
			if (r != null) return r;
			if (isPickedUp) return puppetMaster.muscles[propMuscleID].rigidbody;
			return null;
		}
		...
		protected int propMuscleID { get; private set; }
		protected PuppetMaster puppetMaster { get; private set; }
