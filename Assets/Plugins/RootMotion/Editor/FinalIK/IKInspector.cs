...
namespace RootMotion.FinalIK {
	...
	public abstract class IKInspector : Editor {
		...
		protected SerializedContent updateManually;
		...
		void OnEnable() {
			...
			updateManually = new SerializedContent(serializedObject.FindProperty("updateManually"), new GUIContent("Update Manually", "yes"));
		...
		public override void OnInspectorGUI() {
			...
			Inspector.AddContent(updateManually);
